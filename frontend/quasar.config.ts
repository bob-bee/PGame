...
export default defineConfig((/* ctx */) => {
  return {
    ...
    devServer: {
      // https: true,
      host: '0.0.0.0', // Exposes the server to traffic outside the container (Docker host)
      port: 9000,
      open: false      // Stops the container from attempting to open a browser tab headlessly
    },
